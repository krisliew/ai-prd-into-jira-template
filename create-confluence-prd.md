# Rule: Generating a Product Requirements Document on Confluence (PRD)
...
5.  **Output** the content ready for Confluence and Suggest page title
...
- **Format:** Markdown (`.md`) must be compatible to paste on Confluence
- **Location:** `/prd/`
